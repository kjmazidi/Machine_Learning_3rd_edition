...
This notebook demonstrates R control structures. 

Packages imported in this notebook: mlbench
Data: PimaIndiansDiabetes2 in package mlbench
...
First we load the diabetes data set. The data has 768 observations of 9 variables, which we can see with the structure str() function.  The data was collected from Pima Indian women in the late 1990s. 
