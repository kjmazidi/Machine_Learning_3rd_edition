...
This notebook demonstrates a function to fill NAs, and some additional graphs with parameters. 
...
The *library()* function is sufficient if the mlbench package is already installed. If not, you will get an error. A better way is to use the if statement in which *require()* will return True or False, and install the package if it is not already installed. 
