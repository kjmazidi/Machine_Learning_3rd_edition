...
This notebook demonstrates Logistic Regressionon the titanic data. 

Packages imported in this notebook: 

- ROCR for performance visualizations
- caret for classification metrics
- Data used: titanic.csv, available in the GitHub repo
