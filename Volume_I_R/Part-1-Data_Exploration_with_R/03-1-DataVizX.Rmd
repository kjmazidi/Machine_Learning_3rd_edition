...
### Code Accompanying ***The Machine Learning Handbooks***, Volume I, Chapter 3
...
This notebook demonstrates data visualization in base R on the Titanic data for one quantitative or qualitative variable.

Data imported in this notebook: titanic3.csv, available in the GitHub. 

Packages imported in this notebook: sm (Smoothing Methods for Nonparametric Regression and Density Estimation)
