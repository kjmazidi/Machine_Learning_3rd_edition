...
### Code Accompanying ***The Machine Learning Handbooks***, Volume I, Chapter 6
...
This notebook looks at the built-in data set **women** as an introductory example of linear regression in R.
...
head(pred) # what do predictions look like?
```
