...
This notebook explores kmeans clustering, and is modified from Kabacoff, "R in Action", 2nd ed

This notebook looks at the **nutrient** data set in package **flexclust**
