...
This notebook looks at the built-in data set **airquality** to introduce ridge regression R.


Compare linear regression and ridge regression on the airquality data set.

Packages needed in this notebook: glmnet (Lasso and Elastic-Net Regularized Generalized Linear Models)
